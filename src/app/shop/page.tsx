        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Showing {filteredProducts.length} curated lifestyle essentials
            </p>
          </div>
...
export default function ShopPage() {
  return (
    <Suspense fallback={<div className="max-w-[1400px] mx-auto p-8 text-center text-xs">Loading shop collection...</div>}>
      <ShopContent />
    </Suspense>
  );
}
